...
from M290_MachineSimu_GPU.optical_components_GPU.Fresnel_Direct_Integration_as_Convolution import Fresnel_propagator as DIC
...
class Expander_Fresnel(nn.Module):
    def __init__(self, wavelength):
        ...
        self.propagator = DIC(self.wavelength)
